...
const Header = () => {
  ...
  const [superAdminMode, setSuperAdminMode] = useState(false); // State to store super admin mode
  ...
  // Filter menuData to conditionally show Dashboard based on superAdminMode
  const filteredMenuData = menuData.filter((menuItem) => {
    if (menuItem.title === "Managment" && !superAdminMode) {
      return false;
    }
    return true;
  });
